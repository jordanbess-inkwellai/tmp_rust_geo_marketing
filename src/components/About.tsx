...
const leadership = [
  {
    name: 'John Doe',
    role: 'Founder & CEO',
    imageUrl: 'https://via.placeholder.com/200/0000FF/FFFFFF?text=JD',
    bio: 'Former intelligence officer with 20 years of experience in geospatial technology and defense systems.',
  },
  {
    name: 'Jane Smith',
    role: 'Chief Technology Officer',
    imageUrl: 'https://via.placeholder.com/200/008000/FFFFFF?text=JS',
    bio: 'Lead architect of the Rust-based platform, with a PhD in distributed systems and geospatial data processing.',
  },
  {
    name: 'Robert Johnson',
    role: 'Chief Growth Officer',
    imageUrl: 'https://via.placeholder.com/200/FF0000/FFFFFF?text=RJ',
    bio: 'Business development executive with a track record of securing multi-million dollar government contracts.',
  },
];
