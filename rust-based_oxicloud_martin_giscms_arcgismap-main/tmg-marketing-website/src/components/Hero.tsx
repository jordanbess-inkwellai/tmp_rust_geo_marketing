...
const stats = [
  { label: 'Performance Increase', value: '8x', description: 'Faster data processing' },
  { label: 'Deployment Time', value: '< 30 days', description: 'vs. 18+ months traditional' },
  { label: 'Operational Savings', value: '75%', description: 'Reduced infrastructure costs' },
  { label: 'System Uptime', value: '99.9%', description: 'Mission-critical reliability' },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-secondary-300 mb-8 max-w-2xl">
              Enterprise geospatial intelligence platform engineered for defense and government agencies.
              Accelerate decision-making with real-time data processing, advanced analytics, and seamless interoperability.
            </p>
