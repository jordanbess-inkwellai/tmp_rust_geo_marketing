...
const features = [
  ...
  },
  {
    ...
    description: 'Advanced compute architecture optimized for large-scale geospatial data processing with parallel processing capabilities and efficient memory management.',
    icon: CpuChipIcon,
    benefits: ['High-throughput processing', 'Optimized memory usage', 'Scalable architecture'],
  },
  {
  ...
  },
  {
    ...
    description: 'Integrated ML pipelines for automated feature extraction, anomaly detection, and predictive analytics to enhance analyst productivity.',
    icon: BoltIcon,
    benefits: ['Automated feature detection', 'Anomaly identification', 'Predictive insights'],
  },
  {
  ...
  },
  {
    ...
    description: 'High-performance 3D visualization engine with support for point clouds, mesh rendering, and multi-temporal data display for comprehensive situational awareness.',
    icon: ChartBarIcon,
    benefits: ['Interactive 3D views', 'Multi-layer rendering', 'Temporal analysis'],
  },
  {
